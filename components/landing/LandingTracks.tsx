        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
          ...
          <Link href="/signup" className="block">
            <motion.div
              ...
              viewport={{ once: true }}
              className="group bg-surface border border-primary/30 rounded-xl p-8 hover:border-primary/50 transition-all flex flex-col cursor-pointer hover:shadow-lg hover:shadow-primary/5 h-full"
            >
              ...
              <span className="inline-flex items-center gap-2 text-primary font-mono text-sm group-hover:underline">
                Sign up to unlock →
              </span>
            </motion.div>
          </Link>
          ...
          <Link href="/signup" className="block">
            <motion.div
              ...
              className="group bg-surface border border-accent/30 rounded-xl p-8 hover:border-accent/50 transition-all flex flex-col cursor-pointer hover:shadow-lg hover:shadow-accent/5 h-full"
            >
              <div className="flex items-center gap-3 mb-5">
              ...
              <span className="inline-flex items-center gap-2 text-accent font-mono text-sm group-hover:underline">
                Sign up to unlock →
              </span>
            </motion.div>
          </Link>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-8">
          {[
            ...
            <motion.div
              ...
              className="bg-code-bg border border-border rounded-lg py-3 px-4 text-center cursor-default select-none"
            >
